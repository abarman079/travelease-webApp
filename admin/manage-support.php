...
<div class="container py-5">
    <div class="soft-panel p-4 p-md-5 mb-4">
        ...
        <h1 class="mb-3">Manage Support Tickets</h1>
        <p class="mb-0">Review traveler issues and update ticket status with a response.</p>
    </div>
    ...
    <div class="support-ticket-list">
        <?php foreach ($tickets as $ticket): ?>
            <div class="soft-panel p-4 p-md-4 support-ticket-card mb-4">
                ...
                <form method="POST" action="<?= BASE_URL; ?>/admin/update-ticket.php" class="row g-3">
